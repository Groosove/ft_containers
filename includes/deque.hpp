...
template <class T, class Alloc> bool ft::operator==
		(const ft::deque<T, Alloc> &lhs, const ft::deque<T, Alloc> &rhs) {
	typename ft::deque<T, Alloc>::const_iterator l_it = lhs.begin();
	typename ft::deque<T, Alloc>::const_iterator l_ite = lhs.end();
	typename ft::deque<T, Alloc>::const_iterator r_it = rhs.begin();
	typename ft::deque<T, Alloc>::const_iterator r_ite = rhs.end();
...
template <class T, class Alloc> bool ft::operator!=
		(const ft::deque<T, Alloc> &lhs, const ft::deque<T, Alloc> &rhs) { return !(lhs == rhs); };
...
template <class T, class Alloc> bool ft::operator<=
		(const ft::deque<T, Alloc> &lhs, const ft::deque<T, Alloc> &rhs) { return !(rhs < lhs); };
...
template <class T, class Alloc> void ft::swap (ft::deque<T,Alloc>& x, ft::deque<T,Alloc>& y) { x.swap(y); };